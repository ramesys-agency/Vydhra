...
export default function CourseCard({
  ...
  return (
    <Link href={link} className="group cursor-pointer block h-full">
      <div className="bg-white dark:bg-card-dark border border-gray-100 dark:border-border-dark rounded-[2rem] p-5 shadow-sm hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-2 transition-all duration-500 h-full flex flex-col">
        <div className="relative overflow-hidden aspect-[4/3] rounded-2xl mb-6">
          <Image
            ...
            height={300}
          />
          <div className="absolute top-4 left-4 bg-white/90 dark:bg-black/60 backdrop-blur-md text-primary px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg border border-white/20">
            {category}
          </div>
        </div>
