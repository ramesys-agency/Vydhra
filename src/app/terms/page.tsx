        ...
        <div className="prose dark:prose-invert max-w-none space-y-12">
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              Welcome to Vydhra (“we”, “our”, “us”). Vydhra is a brand Owned and
              Operated by{" "}
              <a
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg mt-4">
              By accessing our website, enrolling in our courses, and purchasing
              our training programs, you agree to be bound by these Terms &
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            <h2 className="text-2xl font-bold mb-4 uppercase tracking-tight text-foreground">
              2. Course Enrollment & Fees
            </h2>
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              To enroll in a course, you are required to provide accurate,
              complete, and current information as prompted during the checkout
              process. Course availability and schedules are subject to change.
            </p>
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg mt-4">
              All fees are payable in the currency specified during checkout
              (INR or USD). You agree to pay all charges incurred by you or on
              your behalf through the payment gateway (Razorpay) at the prices
              in effect when such charges are incurred.
            </p>
          </section>
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              We process payments securely using the <strong>Razorpay</strong>{" "}
              payment gateway. We do not store or host any card details or
              transaction credentials on our servers. You agree to abide by the
              terms and policies of the payment gateway processor used to
          ...
          <section className="relative overflow-hidden bg-gradient-to-br from-orange-500/10 to-primary/5 dark:from-orange-500/20 dark:to-primary/10 p-6 md:p-10 rounded-3xl border-2 border-primary shadow-xl">
            ...
            <h2 className="text-2xl sm:text-3xl font-black mb-4 uppercase tracking-tight text-primary flex items-center gap-2">
              <span className="text-3xl sm:text-4xl">⚠️</span> 4. Refund &
              Cancellation Policy
            </h2>
            ...
            <p className="text-foreground font-extrabold text-base md:text-lg mb-6 leading-relaxed">
              We strive to offer premium educational experiences. Refunds for
              enrollment fees are subject to strict eligibility criteria. A
              refund can be claimed ONLY if the following condition is met:
            </p>
            ...
            <p className="text-xs text-muted-foreground mt-6 italic font-bold">
              ...
              with your enrollment ID, payment receipt, and reason for refund.
            </p>
          </section>
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              All content provided in our courses, including slides, videos,
              code challenges, documentation, and exercises, is the intellectual
              property of Vydhra and Owned and Operated by{" "}
              <a
                href="https://www.ramesys.co.uk/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              to access the materials for your personal learning. Sharing,
              distributing, or copying course materials is strictly prohibited.
            </p>
          </section>
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              You agree to behave in a respectful manner within our community
              spaces, Slack/WhatsApp groups, and live classes. Harassment, hate
              speech, spamming, or sharing malicious software will result in
              immediate termination of your enrollment without any refund.
            </p>
          </section>
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
              To the maximum extent permitted by law, Vydhra and Owned and
              Operated by{" "}
              <a
                href="https://www.ramesys.co.uk/"
                target="_blank"
              ...
              consequential damages resulting from your participation in or
          ...
          <section className="bg-card p-6 md:p-8 rounded-3xl border border-border shadow-sm">
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-4">
              If you have any questions or clarifications regarding these Terms
