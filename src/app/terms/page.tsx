    ...
    <div className="min-h-screen pt-32 pb-20 px-6 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-12">
          ...
          <section className="relative overflow-hidden bg-gradient-to-br from-orange-500/10 to-primary/5 dark:from-orange-500/20 dark:to-primary/10 p-8 md:p-10 rounded-3xl border-2 border-primary shadow-xl">
            ...
            <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-primary flex items-center gap-2">
              <span className="text-4xl">⚠️</span> 4. Refund & Cancellation Policy
            </h2>
            
            <div className="h-1 w-20 bg-primary mb-6" />

            <p className="text-foreground font-extrabold text-lg mb-6 leading-relaxed">
