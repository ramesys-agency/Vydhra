...
export default function EnrollmentClient({
  ...
  const basePrice =
    (selectedBatch?.pricing ? getPrice(selectedBatch.pricing) : null) ??
    coursePriceNum;
  ...
  const validateInfo = () => {
    ...
    if (!info.phone.trim() || info.phone.length < 5)
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      ...
      setCouponResult({
        valid: false,
        error: "Could not validate coupon. Try again.",
      });
    } finally {
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            {/* Student info form */}
            <div className="bg-card/50 backdrop-blur-xl border border-border rounded-3xl p-8 space-y-5 relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid gap-3">
                    {activeBatches.map((batch) => {
                      const batchPrice = formatPrice(
                        batch.pricing || course.pricing,
                      );
                      const seatsLeft =
                        batch.maxSeats != null
                        ...
                        >
                          <div className="space-y-0.5">
                            <div className="flex items-center gap-2">
                              <span
                                className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 ${isSelected ? "border-primary" : "border-muted-foreground/40"}`}
                              >
                                {isSelected && (
                            ...
                            <p className="text-xs text-muted-foreground pl-6">
                              ...
                              {seatsLeft !== null && (
                                <span
                                  className={`ml-2 font-bold ${isFull ? "text-red-500" : seatsLeft <= 5 ? "text-orange-500" : "text-muted-foreground"}`}
                                >
                                  ·{" "}
                                  {isFull
                                    ? "Full"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-1">
                  ...
                  <div
                    className={`phone-input-container ${infoErrors.phone ? "has-error" : ""}`}
                  >
                    <PhoneInput
                      ...
                      onChange={(phone, countryData: any) => {
                        setInfo({
                          ...
                          country: getCountryName(
                            countryData.countryCode?.toUpperCase() || "IN",
                          ),
                        });
                      }}
                      containerClass="!w-full"
                      inputClass={`!w-full !bg-background/60 !border !rounded-2xl !pl-[60px] !pr-5 !py-4 !h-[54px] !outline-none !transition-all !font-medium !text-sm ${
                        infoErrors.phone
                          ? "!border-red-500"
                          : "!border-border focus:!border-primary"
                      }`}
                      buttonClass={`!bg-transparent !border-none !rounded-l-2xl !px-2 hover:!bg-transparent`}
                ...
                <div className="md:col-span-1">
                  ...
                  <div
                    className={`flags-select-container ${infoErrors.country ? "has-error" : ""}`}
                  >
                    <ReactFlagsSelect
                      selected={getCountryCode(info.country)}
                      onSelect={(code) =>
                        setInfo({ ...info, country: getCountryName(code) })
                      }
                      searchable
                ...
                <style jsx global>{`
                  ...
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_filterBox"] {
                    background-color: var(--muted) !important;
                    border: 1px solid var(--border) !important;
                    border-radius: 0.75rem !important;
                    padding: 10px 12px !important;
                  ...
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_label"] {
                    color: var(--foreground) !important;
                  }
                  ...
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_selectOptions"]::-webkit-scrollbar {
                    width: 6px !important;
                    height: 6px !important;
                  }
                  .react-tel-input .country-list::-webkit-scrollbar-track,
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_selectOptions"]::-webkit-scrollbar-track {
                    background: transparent !important;
                  }
                  .react-tel-input .country-list::-webkit-scrollbar-thumb,
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_selectOptions"]::-webkit-scrollbar-thumb {
                    background: var(--border) !important;
                    border-radius: 3px !important;
                  }
                  .react-tel-input .country-list::-webkit-scrollbar-thumb:hover,
                  .flags-select-container
                    [class*="ReactFlagsSelect-module_selectOptions"]::-webkit-scrollbar-thumb:hover {
          ...
          <div className="lg:col-span-5">
            <div className="bg-card border border-border rounded-[2.5rem] p-8 shadow-2xl sticky top-28 overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                ...
                {gstAmount > 0 ? (
                  <div className="flex justify-between text-muted-foreground">
                    <span className="font-medium">GST (18% Exclusive)</span>
                    <span className="font-bold">
                      {currencySymbol}
                  ...
                  <div className="text-[10px] text-muted-foreground italic flex justify-between">
                    <span>Export of Services (excl. GST / zero-rated)</span>
                  </div>
                )}
                ...
                <div className="flex justify-between items-end mb-8">
                  ...
                  <div className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-black animate-pulse">
                    {gstAmount > 0 ? "GST INCLUDED" : "BEST VALUE"}
                  </div>
                </div>

                {/* Terms & Conditions Checkbox */}
                <div className="flex items-start gap-3 bg-muted/20 p-4 rounded-2xl border border-border/50 mb-6 transition-all hover:bg-muted/30">
                  <input
                    type="checkbox"
                    id="terms-checkbox"
                    checked={agreedToTerms}
                    onChange={(e) => setAgreedToTerms(e.target.checked)}
                    className="w-5 h-5 rounded border-border text-primary focus:ring-primary accent-primary cursor-pointer mt-0.5 shrink-0"
                  />
                  <label
                    htmlFor="terms-checkbox"
                    className="text-xs font-semibold text-muted-foreground leading-relaxed cursor-pointer select-none"
                  >
                    I agree to the{" "}
                    <Link
                      href="/terms"
                    ...
                    and confirm that I have read and accepted the refund policy.
                  </label>
                </div>
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      <Icon name="lock" size={20} /> PAY {currencySymbol}
                      {total.toLocaleString("en-US")}
                    </>
                  )}
                </button>
        ...
        <div className="mt-28 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Everything you need to know about enrollment and payment.
            </p>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3
                    className={`text-lg font-bold transition-colors pr-8 ${openFaqIndex === index ? "text-primary" : "group-hover:text-primary"}`}
                  >
                    {faq.question}
                  </h3>
                  <div
                    className={`w-10 h-10 rounded-full bg-muted flex items-center justify-center transition-transform duration-500 ${openFaqIndex === index ? "rotate-180 bg-primary/10 text-primary" : ""}`}
                  >
...
const faqs = [
  {
    ...
    answer:
      "Instantly! Once your payment is processed, you'll receive an email with your login credentials and immediate access to the learning dashboard and community.",
  },
  {
    question: "Is my payment secure?",
    answer:
      "Yes. We use Razorpay with industry-standard encryption to ensure your transaction details are 100% protected.",
  },
  {
    question: "What is your refund policy?",
    answer:
      "We offer a 14-day no-questions-asked money-back guarantee. Email us and we'll refund the full amount.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Currently we only offer one-time payments. EMI options are coming for future cohorts.",
  },
];
